...
export const createTenorCall = (desc) =>
  `https://api.tenor.com/v1/search?q=${desc}&key=${TENOR_KEY}&limit=8&media_filter=minimal`;
...
const randomFromArray = (arr) =>
  nth(Math.floor(Math.random() * arr.length), arr);
export const getGifUrl = pipe(
  randomFromArray,
  prop("media"),
  head,
  prop("gif"),
